{
  "info": {
    ...
    "_postman_id": "5aec71e4-df1f-478d-8401-885b14b7b9b0",
  ...
  "item": [
    {
      ...
      "item": [
        {
          "id": "33c07634-8759-4603-9db5-3c5862654910",
          "name": "listLicenses",
          "request": {
          ...
          "response": [
            {
              ...
              "code": 200,
              "name": "Response_200",
              "id": "1065cda4-fd8f-4e3f-9a57-a4557093303e"
            }
          ]
        },
        {
          "id": "f9675540-dedb-411b-b9b5-4daf4e107e1f",
          "name": "createLicense",
          "request": {
            "url": "http://go.netlicensing.io/core/v2/rest/license",
            "method": "POST",
          ...
          "response": [
            {
              ...
              "code": 200,
              "name": "Response_200",
              "id": "40139096-2076-4be8-8aca-ae45e2e7378d"
            }
          ]
        },
        {
          "id": "b82dd8d3-e20d-4869-9eca-b2c237ad577b",
          "name": "getLicense",
          "request": {
            "url": {
              "protocol": "http",
          ...
          "response": [
            {
              ...
              "code": 200,
              "name": "Response_200",
              "id": "35451368-aaa0-422b-963f-ff631a68751d"
            }
          ]
        },
        {
          "id": "fd67bfc9-e710-4fb7-9241-db3776d84704",
          "name": "updateLicense",
          "request": {
            "url": {
              "protocol": "http",
          ...
          "response": [
            {
              ...
              "code": 200,
              "name": "Response_200",
              "id": "11c4c40e-33dd-4904-ad2d-010dfa1cb23f"
            }
          ]
        },
        {
          "id": "b64bf686-f5ba-4776-8e6d-9b691e3e725c",
          "name": "deleteLicense",
          "request": {
            "url": {
              "protocol": "http",
          ...
          "response": [
            {
              ...
              "code": 200,
              "name": "Response_200",
              "id": "c37c723f-8210-4646-b65e-b7529e6e2818"
            }
          ]
        }
      ]
    },
    {
      ...
      "item": [
        {
          "id": "892cb352-dff6-4ca1-a2a8-60eab10980c5",
          "name": "listLicensees",
          "request": {
          ...
          "response": [
            {
              ...
              "code": 200,
              "name": "Response_200",
              "id": "42741861-a2d2-47f6-bc25-304f65e386bb"
            }
          ]
        },
        {
          "id": "9b4bedfd-3205-4fd0-9fe3-90446dcf5da1",
          "name": "createLicensee",
          "request": {
            "url": "http://go.netlicensing.io/core/v2/rest/licensee",
            "method": "POST",
          ...
          "response": [
            {
              ...
              "code": 200,
              "name": "Response_200",
              "id": "c52b8a69-129a-46c9-99aa-80af07e7d0a7"
            }
          ]
        },
        {
          "id": "bd093757-1feb-4415-aab0-f60a3598cfa4",
          "name": "getLicensee",
          "request": {
            "url": {
              "protocol": "http",
          ...
          "response": [
            {
              ...
              "code": 200,
              "name": "Response_200",
              "id": "7a9c2929-20cb-46aa-8071-2491b1fc4b12"
            }
          ]
        },
        {
          "id": "17a78b17-1839-4261-8489-c7d2a9111bf7",
          "name": "updateLicensee",
          "request": {
            "url": {
              "protocol": "http",
          ...
          "response": [
            {
              ...
              "code": 200,
              "name": "Response_200",
              "id": "47ebefd7-072f-4046-97b5-ef83ab45a6f0"
            }
          ]
        },
        {
          "id": "9a16929d-fcc6-4691-a59f-f51c72b2925a",
          "name": "deleteLicensee",
          "request": {
            "url": {
              "protocol": "http",
          ...
          "response": [
            {
              ...
              "code": 200,
              "name": "Response_200",
              "id": "f64a3965-09bb-477a-ab9b-e9fb1c5becb2"
            }
          ]
        }
      ]

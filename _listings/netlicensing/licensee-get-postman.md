{
  "info": {
    ...
    "_postman_id": "39fcede3-9286-40e3-a4e0-a90c028f0279",
  ...
  "item": [
    {
      ...
      "item": [
        {
          "id": "00ecb697-f8d3-4e21-aaa3-cf08e92b29d2",
          "name": "listLicenses",
          "request": {
          ...
          "response": [
            {
              ...
              "code": 200,
              "name": "Response_200",
              "id": "ca6a4e64-9b4c-4913-ba3f-675ebda716c6"
            }
          ]
        },
        {
          "id": "c2ed9bf0-6cd5-4d9a-bd05-eb9fd505624d",
          "name": "createLicense",
          "request": {
            "url": "http://go.netlicensing.io/core/v2/rest/license",
            "method": "POST",
          ...
          "response": [
            {
              ...
              "code": 200,
              "name": "Response_200",
              "id": "2cbf82e4-43b0-4ec1-8286-a2139612b4bc"
            }
          ]
        },
        {
          "id": "2b5251a8-0150-4d2b-8ea5-3998c2e1d490",
          "name": "getLicense",
          "request": {
            "url": {
              "protocol": "http",
          ...
          "response": [
            {
              ...
              "code": 200,
              "name": "Response_200",
              "id": "613d7c29-d177-4aaf-a68a-1420337779a9"
            }
          ]
        },
        {
          "id": "691e6265-b393-454b-94e4-74f83a2b9ea7",
          "name": "updateLicense",
          "request": {
            "url": {
              "protocol": "http",
          ...
          "response": [
            {
              ...
              "code": 200,
              "name": "Response_200",
              "id": "7fcba689-4a63-4701-a78f-019816c26ac0"
            }
          ]
        },
        {
          "id": "c6db9a0c-f9ab-46f3-bd9f-a4fdcbfc5b9c",
          "name": "deleteLicense",
          "request": {
            "url": {
              "protocol": "http",
          ...
          "response": [
            {
              ...
              "code": 200,
              "name": "Response_200",
              "id": "8db233dc-7259-4b86-b05b-de12730c9a3f"
            }
          ]
        }
      ]
    },
    {
      ...
      "item": [
        {
          "id": "57711cfc-35a9-4bc6-a1ff-092a4b93635b",
          "name": "listLicensees",
          "request": {
          ...
          "response": [
            {
              ...
              "code": 200,
              "name": "Response_200",
              "id": "f00dd763-d610-48a5-aaa3-8c782055bb01"
            }
          ]
        }
      ]

{
  "info": {
    ...
    "_postman_id": "f58d3d7b-c6d4-41e4-be55-d27df83d1477",
  ...
  "item": [
    {
      ...
      "item": [
        {
          "id": "690c0389-e588-484e-94b0-ee423a9164bb",
          "name": "listLicenses",
          "request": {
          ...
          "response": [
            {
              ...
              "code": 200,
              "name": "Response_200",
              "id": "4b1f5ce7-852e-43aa-8e6b-8927bc057f37"
            }
          ]
        },
        {
          "id": "e063cbd2-a8c2-4405-a1c0-ec7b0aaf4684",
          "name": "createLicense",
          "request": {
            "url": "http://go.netlicensing.io/core/v2/rest/license",
            "method": "POST",
          ...
          "response": [
            {
              ...
              "code": 200,
              "name": "Response_200",
              "id": "4186de13-eae4-49be-8c99-2bbad13052ed"
            }
          ]
        },
        {
          "id": "e73a84e8-620a-4f1e-9a91-b63a230a96d8",
          "name": "getLicense",
          "request": {
            "url": {
              "protocol": "http",
          ...
          "response": [
            {
              ...
              "code": 200,
              "name": "Response_200",
              "id": "faf45939-db88-4f3b-8aa4-5d4b41e7a385"
            }
          ]
        },
        {
          "id": "cc87153f-2187-4c01-8bf6-90a094278d94",
          "name": "updateLicense",
          "request": {
            "url": {
              "protocol": "http",
          ...
          "response": [
            {
              ...
              "code": 200,
              "name": "Response_200",
              "id": "de79b9eb-f0b8-4453-8c16-5ac2412b43e7"
            }
          ]
        },
        {
          "id": "f0f0de15-6bbf-4a53-ad1d-ef51479ebe23",
          "name": "deleteLicense",
          "request": {
            "url": {
              "protocol": "http",
          ...
          "response": [
            {
              ...
              "code": 200,
              "name": "Response_200",
              "id": "5215e4f5-2901-469c-8176-f605e3cef6c2"
            }
          ]
        }
      ]
